//
//  DeliveryInDeliveryViewController.swift
//  POD
//
...
class DeliveryInDeliveryViewController: UIViewController {
...
//        currentTableData.append(Order(orderID: 000001, dateTime: "2017-04-25 19:15:08", productSKU: "CF3374530", customerID: 100013, statusID: 1, warehouseStaffID: 1, driverID: 1, vehicleID: 1, dcStaffID: 1, insuranceID: 1))
...
//        currentTableData.append(Order(orderID: 000001, dateTime: "2017-04-02 05:12:41", productSKU: "CK0837410", customerID: 100001, statusID: 1, warehouseStaffID: 1, driverID: 1, vehicleID: 1, dcStaffID: 1, insuranceID: 1))
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        print("In-Delivery VC will appear")
    }
    
    override func viewWillDisappear(_ animated: Bool) {
        super.viewWillDisappear(animated)
        print("In-Delivery VC will disappear")
    }
    ...
    func fetchOrder(){
        network.fetchOrderArray(status: 6
...
extension DeliveryInDeliveryViewController: UITableViewDelegate, UITableViewDataSource{
